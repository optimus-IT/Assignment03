...
public class GraphicDemo2 extends Canvas {
    ...
    public void paint( Graphics g){
        ...
        g.drawArc(270, 20, 100, 200, 0, 270); // draw an arc that starts at 0 degrees 
                                              // and has an arclenght of 270 degrees
        g.drawArc(50, 250, 150, 150, 90, 180);
        g.drawArc(210, 250, 150, 150, 45, 90);
        g.fillArc(210, 280, 150, 1550, 45, 90);
        
        g.setColor(Color.yellow);
        g.fillArc(150, 400, 150, 150, 45, 270);// chomp
        
        // custom colors
        Color myOrange = new Color (230,92,0); // amount of red, blue, green in the color
                                              // Each componenet has a value from 0-255
        g.setColor(myOrange);
    ...
    public static void main(String[] args) {
        ...
        GraphicDemo2 canvas = new GraphicDemo2();
        win.add(canvas);
        win.setVisible(true);
    }
}
