...
public class ImageDemo extends Canvas
{
	...
	{
		coolFace = ImageIO.read( new File("src/assignment3_10533695/resources/mitch.png") );
                camaro = ImageIO.read( new File("src/assignment3_10533695/resources/camaro.jpeg") );
